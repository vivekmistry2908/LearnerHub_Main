            ...
            <div className='row m-0 pb-5 px-3 px-md-0' style={{backgroundColor:'#F9F9FB'}}>
              <div className='col-lg-5 col-md-8 mx-auto'>
                <div className='d-flex align-items-center justify-content-evenly py-4'>
                  ...
                  <input type="radio" id='existing' name='user'/>
                  <label htmlFor="existing" className='support-text1 ms-2'>Existing User</label>
                  </div>
                  <div className='d-flex align-items-center'>
                  <input type="radio"  id='new' name='user'/>
                  <label htmlFor="new" className='support-text1 ms-2'>New User</label>
                  </div>
                </div>
